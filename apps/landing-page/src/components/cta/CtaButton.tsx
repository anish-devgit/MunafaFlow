...
export const ctaButtonVariants = cva("", {
  variants: {
    variant: {
      default:
  "relative overflow-hidden text-black bg-linear-to-b border border-[#128C7E] from-[#25D366] to-[#128C7E] to-57% shadow-[inset_0_3px_2px_0_rgba(255,255,255,0.4)] active:from-[#075E54] active:to-[#128C7E] active:from-43% active:to-100% active:shadow-[inset_0_-2px_2px_0_rgba(255,255,255,0.2)] before:bg-transparent hover:before:bg-white/40 before:w-1/4 before:absolute before:-left-[40%] hover:before:left-[120%] before:transition-[left] before:duration-0 hover:before:duration-700 before:blur-md before:-rotate-45 before:aspect-1/2 font-bold",
  secondary:
